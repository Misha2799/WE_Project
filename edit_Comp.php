                    ...
                    <form action="update_Comp.php" method="POST" enctype="multipart/form-data">
                        <table>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td>:</td>
                                <td><textarea id="desc" name="desc" rows="4" cols="50" class="form-control" required><?php echo $desc?></textarea></td>                                                           
                            </tr>
                            <tr>
                        ...
                        <center>
                            ...
                            <button type="back" name="back" class="btn btn-primary"><a href="tablestd.php">Back</a></button>
                        <center>
                    </form>
                </div>
             </div>
