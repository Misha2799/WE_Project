...
$query1 = "SELECT complaint_date,type_complaint,desc_complaint, status_complaint, image FROM complain WHERE id=$id";
$query_run1 = mysqli_query($conn,$query1);

while($row = mysqli_fetch_array($query_run1)){
    $date = $row['complaint_date']. "<br>"; 
    $type = $row['type_complaint']. "<br>";
    $desc = $row['desc_complaint']. "<br>"; 
    $status = $row['status_complaint'];
    $fn = $row['image'];
}  
