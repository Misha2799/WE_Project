...
while($row = mysqli_fetch_array($query_run1)){
    ...
    $provepic = $row['provepic']. "<br>";
   
}


$query = "SELECT user_id, first_name, phone_number FROM user";
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <table>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td><label for="type">Prove Pic</label></td>
                                <td></td>
                                <td></td>
                                <td>:</td>
                                <td></td>
                                <td><img src ="<?php echo $fn;?>" height="160" width="250" class="img-responsive"/></td>                                                           
                            </tr>
